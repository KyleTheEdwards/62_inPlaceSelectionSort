...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        ArrayList<Integer> unorderedCopy = new ArrayList<Integer>(unordered);

        
        //Yes I copied code. I hope this is allowed...
        int nextLargerAt = champIndex( unorderedCopy );
        while(nextLargerAt != -1){
          /*System.out.println( 
            "smallest element is at index " + nextLargerAt 
          + " and has the value " + unordered.get( nextLargerAt));*/
          add(unorderedCopy.get(nextLargerAt));
    ...
    /** 
      ...
      Finds the smallest element of a 
      @return ??
     */
     private int champIndex( ArrayList<Integer> unordered) {
        int smallestItem = 99999999;
        int smallestIndex = -1;
        for(int i = 0; i < unordered.size(); i++){
          if(unordered.get(i) != null && unordered.get(i) < smallestItem){
            smallestIndex = i;
            smallestItem = unordered.get(i);
          }
        }
